...
def CheckMyWorkNoLoginTitle(driver):
    ...
    try:
        ...
        assert (isExistElementByID(driver,"app_bar") == True),"app_bar error"
        assert (isExistElementByID(driver,"collapsing_layout") == True),"collapsing_layout error"
        ...
        assert (isExistTextInElementByID(driver,"tv_name","Log in") == True),"Log in error"
        assert (isExistTextInElementByID(driver,"tv_sync_tip","Log in to sync your data on any device") == True),"Log in to sync your data on any device error"
...
def CheckMyWorkLoginTitle(driver):
    ...
    try:
        ...
        assert (isExistTextInElementByID(driver,"tv_sync_tip","Last sync time: less than 1 day") == True),"Last sync time error"
